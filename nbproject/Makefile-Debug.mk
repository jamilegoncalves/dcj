...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/dcj-subst
...
${OBJECTDIR}/DoubleCutAndJoin.o: DoubleCutAndJoin.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DoubleCutAndJoin.o DoubleCutAndJoin.cc

${OBJECTDIR}/Adjacency.o: Adjacency.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Adjacency.o Adjacency.cc

${OBJECTDIR}/Substitution.o: Substitution.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Substitution.o Substitution.cc

${OBJECTDIR}/Genome.o: Genome.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Genome.o Genome.cc

${OBJECTDIR}/AdjacencyGraph.o: AdjacencyGraph.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AdjacencyGraph.o AdjacencyGraph.cc

${OBJECTDIR}/Deletion.o: Deletion.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Deletion.o Deletion.cc

${OBJECTDIR}/Insertion.o: Insertion.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Insertion.o Insertion.cc

${OBJECTDIR}/Rearrangement.o: Rearrangement.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Rearrangement.o Rearrangement.cc

${OBJECTDIR}/Chromosome.o: Chromosome.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Chromosome.o Chromosome.cc
